  ...
  const sampleProperties = [
    {
      ...
      bhk: '3BHK',
      locality: 'Uttam Nagar West, South West Delhi',
      price_value: 9500000,
      price_label: '95 Lakh',
      area_sqft: 1450,
      floor: '2nd Floor',
    ...
    },
    {
      ...
      bhk: '4BHK',
      locality: 'Om Vihar, South West Delhi',
    ...
    },
    {
      ...
      bhk: '2BHK',
      locality: 'Nawada, South West Delhi',
      price_value: 6200000,
      price_label: '62 Lakh',
      area_sqft: 950,
      floor: 'Ground Floor',
    ...
    },
    {
      ...
      bhk: '3BHK',
      locality: 'Dwarka Mor, South West Delhi',
...
async function seedBlogPosts() {
  ...
  const posts = [
    {
      title: 'A First-Time Buyer\'s Guide to South West Delhi Localities',
      slug: 'first-time-buyer-guide-west-delhi-localities',
      excerpt: 'Uttam Nagar West, Om Vihar, Nawada, Dwarka Mor — each South West Delhi locality has a different character and price range. Here\'s how to think about which one fits your budget and lifestyle.',
      body: `<p>South West Delhi isn't one neighbourhood — it's several distinct ones, each with its own pricing, connectivity, and character. If you're buying your first home here, the locality you choose matters almost as much as the flat itself.</p>
...
<p>Always verify the floor's registry documents, sanctioned building plan, and whether the terrace/parking rights are clearly assigned in writing — these are the most common sources of dispute later. We walk every client through this checklist before they sign anything.</p>`,
    ...
    },
    {
      ...
      excerpt: 'Buying resale in South West Delhi? These five questions will save you from the most common surprises after you\'ve already paid the token amount.',
      body: `<p>Resale homes move fast in South West Delhi, and it's easy to get caught up in the excitement of a good price. Before you commit, make sure you've got clear answers to these five questions.</p>
