      ...
      <div class="modal-content" style="max-width:680px;">
        ...
        <form id="property-form">
          ...
          <div class="form-group">
            ...
            <input type="text" id="p-locality" required value="${property ? escapeAttr(property.locality) : ''}" placeholder="e.g. Janakpuri, West Delhi">
          </div>

          <div class="form-row">
            <div class="form-group">
              <label for="p-price-value">Price (numeric, in &#8377;) *</label>
              <input type="number" id="p-price-value" required value="${property ? property.price_value : ''}" placeholder="9500000">
            </div>
            <div class="form-group">
              <label for="p-price-label">Price Display Label *</label>
              <input type="text" id="p-price-label" required value="${property ? escapeAttr(property.price_label) : ''}" placeholder="e.g. 95 Lakh">
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input type="text" id="p-floor" value="${property ? escapeAttr(property.floor || '') : ''}" placeholder="e.g. 2nd Floor">
            </div>
            <div class="form-group">
              <label for="p-facing">Facing</label>
              <input type="text" id="p-facing" value="${property ? escapeAttr(property.facing || '') : ''}" placeholder="e.g. East Facing">
            </div>
          </div>
...
async function handlePropertySave(e) {
  ...
  const payload = {
    ...
    price_value: parseFloat(document.getElementById('p-price-value').value),
    price_label: document.getElementById('p-price-label').value.trim(),
